...
\begin{mdlisting}
\begin{center} \textbf{Appendix \arabic{appcount}}\\ ./events/event.py \end{center}
\lstinputlisting[language=python,basicstyle=\footnotesize]{/home/drewman/test/Nao-PPTX/src/events/event.py}
\end{mdlisting}
\stepcounter{appcount}
...
\begin{mdlisting}
\begin{center} \textbf{Appendix \arabic{appcount}}\\ ./web/webinterface.py \end{center}
\lstinputlisting[language=python,basicstyle=\footnotesize]{/home/drewman/test/Nao-PPTX/src/web/webinterface.py}
\end{mdlisting}
\stepcounter{appcount}
